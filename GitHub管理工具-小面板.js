...
(function() {
    ...
    function createControlPanel(container) {
        ...
        panel.innerHTML = `
            <h3>📁 GitHub批量文件管理工具 v3.8.3</h3>
            <div class="github-tools-toggle" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px; padding-bottom: 8px; border-bottom: 1px solid #e1e4e8;">
                <span style="font-weight: 600; font-size: 12px;">脚本启用状态：</span>
                <label class="switch">
                    <input type="checkbox" ${StateManager.getScriptEnabled() ? 'checked' : ''}>
                    <span class="slider"></span>
                </label>
            </div>
            <p style="font-size: 11px; margin-bottom: 10px;"><strong>功能说明：</strong></p>
            <ul style="margin: 8px 0 15px 0; padding-left: 18px; color: #586069; font-size: 11px; line-height: 1.4;">
                <li>删除所有文件（保留目录结构）</li>
                <li>保留结构式删除文件</li>
            ...
            <div class="github-tools-buttons">
                ...
                <button class="github-tool-btn settings" id="tm-configure-token">配置Token</button>
            ...
            <div style="margin-top: 15px; padding: 8px; background: #f8f9fa; border-radius: 3px; font-size: 11px; color: #6c757d; line-height: 1.3;">
    ...
    function main() {
        ...
        if (StateManager.isGitHubPage() && StateManager.getScriptEnabled()) {
            console.log('GitHub批量工具 v3.8.3 - 开始初始化');
        ...
        const checkPageLoaded = () => {
            if (document.readyState === 'complete' && document.querySelector('body')) {
                setTimeout(() => {
                    try {
                        new GitHubUIManager();
                        console.log('GitHub批量工具 v3.8.3 初始化成功');
                    } catch (error) {
            ...
            return new Promise((resolve, reject) => {
                const options = {
                    ...
                    headers: {
                        ...
                        'User-Agent': 'GitHub-Batch-Tools/3.8.3'
                    },
                    timeout: 30000,
                    onload: (response) => {
    ...
    class FixedFileOperations {
        constructor(api) {
            this.api = api;
            this.repoInfo = this.getCurrentRepo();
...
`;
            ...
            const { value: strategy } = await Swal.fire({
                ...
                html: `
                    <div style="text-align: left; font-size: 13px;">
                        ...
                        ${conflicts.length <= 10 ? 
                            `<div style="max-height: 150px; overflow-y: auto; margin: 8px 0; padding: 8px; background: #f6f8fa; border-radius: 4px; font-size: 12px;">
                                ${conflictListHtml}
                            </div>` :
                            `<p>显示前10个冲突文件...</p>`
                        }
    ...
    class GitHubUIManager {
                ...
                html: `
                    <div style="text-align: left; font-size: 13px;">
                        ...
                        <ul style="margin-left: 16px; margin-bottom: 10px;">
                            ...
                            <li>分支: ${this.getCurrentBranch()}</li>
                        </ul>
                        <hr style="margin: 8px 0;">
                        <p><strong>快捷键:</strong> Ctrl+Shift+G 显示/隐藏面板</p>
                        <p><strong>版本:</strong> 3.8.3 (修复设置弹窗问题)</p>
                    </div>
                `,
                showDenyButton: true,
                showCancelButton: true,
        ...
        async deleteRepository() {
            ...
            const warningResult = await Swal.fire({
                ...
                html: `
                    <div style="text-align: left; font-size: 13px;">
                        <p style="color: #dc3545; font-weight: bold; margin-bottom: 10px;">您将要永久删除存储库！</p>
                        <div class="danger-note">
                        ...
                        <input type="text" id="confirm-danger" class="swal2-input" placeholder="输入 DELETE" autocomplete="off" style="font-size: 13px;">
                    </div>
                `,
                icon: 'error',
                showCancelButton: true,
            ...
            try {
                ...
                const repoDetailsHtml = `
                    <div style="text-align: left; font-size: 13px;">
                        ...
                        <div class="danger-note" style="margin: 10px 0;">
                            <p><strong>再次警告：此操作不可撤销！</strong></p>
                            <p>请在下方输入完整的仓库名称以确认删除：</p>
                            <input type="text" id="confirm-repo-fullname" class="swal2-input" placeholder="${repositoryData.full_name}" autocomplete="off" style="font-size: 13px;">
                        </div>
                    </div>
                `;
                ...
                await Swal.fire({
                    ...
                    html: `
                        <div style="text-align: center; font-size: 13px;">
                            <p style="margin-bottom: 10px;">存储库 <strong>${repositoryData.full_name}</strong> 已成功删除。</p>
                            <p>页面将在5秒后跳转到您的仓库列表...</p>
                            <div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 4px; border: 1px solid #e1e4e8; font-size: 12px;">
                                <p><strong>已删除的内容：</strong></p>
                                <ul style="text-align: left; margin: 8px 0; padding-left: 16px;">
                                    <li>所有文件和文件夹</li>
                                    <li>提交历史和分支</li>
                    ...
                    html: `
                        <div style="text-align: center;">
                            <div class="upload-area" id="upload-area">
                                ...
                                <p>支持拖放文件/文件夹到此处</p>
                                <p style="font-size: 11px; color: #586069;">最大文件大小: ${CONFIG.MAX_FILE_SIZE / (1024*1024)}MB</p>
                            </div>
                ...
                const confirmUpload = await Swal.fire({
                    ...
                    html: `
                        <div style="text-align: left; font-size: 13px;">
                            ...
                            <p style="color: #fd7e14; margin-top: 10px; font-size: 12px;">上传过程中会自动检测并处理同名文件冲突。</p>
                        </div>
                    `,
                    icon: 'question',
                    showCancelButton: true,
        ...
        updateFileList() {
            ...
            if (this.uploadManager.files.length > maxDisplay) {
                ...
                moreItem.innerHTML = `
                    <div style="text-align: center; width: 100%; color: #586069; font-style: italic; font-size: 11px;">
        ...
        async deleteAllFiles() {
            ...
            const result = await Swal.fire({
                ...
                html: `
                    <div style="text-align: left; font-size: 13px;">
                        ...
                        <p>请在下方输入仓库名称以确认:</p>
                        <input type="text" id="confirm-repo-name" class="swal2-input" placeholder="${repoName}" autocomplete="off" style="font-size: 13px;">
                    </div>
                `,
                icon: 'warning',
                showCancelButton: true,
            ...
            try {
                ...
                const progressSwal = Swal.fire({
                    ...
                    html: `
                        <div style="text-align: center;">
                            ...
                            <div id="swal-status-text" class="status-text" style="font-size: 12px;">初始化扫描...</div>
                        </div>
                    `,
                    allowOutsideClick: false,
                    showConfirmButton: false,
                ...
                await Swal.fire({
                    ...
                    html: `
                        <div style="text-align: center;">
                            ...
                            <div id="swal-status-text" class="status-text" style="font-size: 12px;">开始删除文件...</div>
                        </div>
                    `,
                    allowOutsideClick: false,
                    showConfirmButton: false,
                ...
                if (failedFiles.length > 0) {
                    ...
                    resultHtml += `<ul style="text-align: left; font-size: 11px; margin-top: 5px;">`;
        ...
        async deleteFilesAndKeepStructure() {
            ...
            try {
                ...
                // 文件删除结果
                resultHtml += `<h4 style="margin-top: 10px; margin-bottom: 8px; font-size: 14px;">📁 文件删除结果：</h4>`;
                ...
                // .gitignore创建结果
                resultHtml += `<h4 style="margin-top: 10px; margin-bottom: 8px; font-size: 14px;">📄 .gitignore创建结果：</h4>`;
                ...
                if (hasFileFailures || hasGitignoreFailures) {
                    ...
                    if (hasFileFailures) {
                        resultHtml += `<h5 style="margin-top: 8px; margin-bottom: 5px; font-size: 12px;">🗑️ 文件删除失败：</h5>`;
                    ...
                    if (hasGitignoreFailures) {
                        resultHtml += `<h5 style="margin-top: 8px; margin-bottom: 5px; font-size: 12px;">📄 .gitignore创建失败：</h5>`;
                ...
                // 操作总结
                resultHtml += `<br><div style="margin-top: 10px; padding: 8px; background: #f8f9fa; border-radius: 3px; border-left: 3px solid #fd7e14; font-size: 12px;">`;
                ...
                await Swal.fire({
                    ...
                    html: `
                        <div style="text-align: center;">
                            ...
                            <div id="swal-status-text" class="status-text" style="font-size: 12px;">开始创建.gitignore文件...</div>
                        </div>
                    `,
                    allowOutsideClick: false,
                    showConfirmButton: false,
    ...
    if (typeof GM_registerMenuCommand !== 'undefined') {
        ...
        GM_registerMenuCommand('测试API连接', () => {
            const repoInfo = (new GitHubUIManager()).getCurrentRepo();
            if (repoInfo.isRepoPage) {
